...
## Revisión 0.1.1: preparar aviso individual

Al elegir un miembro activo con teléfono, el botón «Preparar WhatsApp» abre `https://wa.me/<teléfono>?text=<mensaje>` tras la pulsación explícita. Se interpreta un teléfono local dominicano de diez dígitos con prefijo 1, o un número internacional de 11 a 15 dígitos. La aplicación no puede verificar si WhatsApp se abrió o si se pulsó Enviar, por lo que no registra ninguno de los estados enviado, aceptado ni entregado. [Ayuda oficial de WhatsApp: mensaje prellenado](https://faq.whatsapp.com/5913398998672934). Esto requiere Internet y WhatsApp para el envío, aunque el directorio y la programación funcionan offline. Para el grupo personal existente permanece la exportación manual; la Groups API oficial describe grupos propios creados por cuenta empresarial, no la adopción de un grupo personal preexistente.
